...
When `reporting a bug <https://github.com/python-desert/python-desert/issues>`_ please include:
...
The best way to send feedback is to file an issue at https://github.com/python-desert/python-desert/issues.
...
1. Fork `python-desert <https://github.com/python-desert/python-desert>`_
...
.. [1] If you don't have all the necessary python versions available locally you can rely on Travis - it will
       `run the tests <https://travis-ci.org/python-desert/python-desert/pull_requests>`_ for each change you add in the pull request.
